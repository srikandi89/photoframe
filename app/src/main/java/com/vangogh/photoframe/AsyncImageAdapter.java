...
public class AsyncImageAdapter extends RecyclerView.Adapter<AsyncImageAdapter.MyViewHolder> {
    private List<ImageContent> contents;
    private Context context;
    private AsyncImageDownloader imageDownloader;

    public AsyncImageAdapter(Context context, List<ImageContent> contents, AsyncImageDownloader imageDownloader) {
